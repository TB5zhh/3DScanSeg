...
misc_arg.add_argument('--train_dataset', type=str, default='')
misc_arg.add_argument('--val_dataset', type=str, default='')
...
misc_arg.add_argument('--train_batch_size', type=int, default=8)
misc_arg.add_argument('--val_batch_size', type=int, default=8)
